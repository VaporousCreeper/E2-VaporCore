...
E2Helper.Descriptions["entitys"] = "Returns an array of all existing entitys in the world"
E2Helper.Descriptions["entitysByModel"] = "Returns all entitys with the model"
E2Helper.Descriptions["entitysByClass"] = "Returns all entitys with the class"

E2Helper.Descriptions["timer"] = "Starts a timer with repetitions, 0 for infinite"
